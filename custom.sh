...
sudo adduser yuni1 --gecos "" --disabled-password
sudo adduser yuni2 --gecos "" --disabled-password

# Mengatur password untuk yuni1 dan yuni2
echo "yuni1:egan1337" | sudo chpasswd
echo "yuni2:egan1337" | sudo chpasswd

# Memberikan akses root ke yuni1 dan yuni2
sudo usermod -aG sudo yuni1
sudo usermod -aG sudo yuni2
